...
pygame.init()
oDisplayText1 = pygwidgets.DisplayText (window, (10, 30), "Number of Balls clicked",
                                       fontSize=42, width=400, textColor=BLACK,)
oDisplayText2 = pygwidgets.DisplayText (window, (10, 100), "Time Left",
                                        fontSize=42, width= 400, textColor=BLACK,)
...
while True:
    ...
    for oBall in ballList:
        ...
        counter = counter + 1
        oDisplayText1.setValue("Number of Balls clicked:  0" + str (counter))
        oDisplayText2.setValue("Time left: 0" + str (counter))
